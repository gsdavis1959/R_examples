...
data <- readr::read_csv("https://raw.githubusercontent.com/connorrothschild/R/master/refugee-trends/data/final/final_data.csv")
...
data <- data %>% rename(state = nat_definition4)
